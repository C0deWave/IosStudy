...
이번에는 이전에 했던 프로젝트에서 이미지를 추가해서 현재의 상태를 표시하는 작업을 했습니다.

추가적으로 저번 프로젝트에서 시간이 제대로 표시되지 않는 에러가 있어서 어느 부분이 문제일까 찾아보다가 실습을 하는데 시간에 많이 걸린것 같습니다.

문제는 서식문자에서 %02 뒤에 d를 붙이지 않아서 발생했습니다. 잘 찾아내서 다행입니다.

![스크린샷 2020-08-05 오전 7 55 19](https://user-images.githubusercontent.com/16849874/89354932-12dc9900-d6f5-11ea-95bb-6f8145ea869b.png)

---

## 내부 또는 링크에 있는 동영상 재생하기

프로젝트명 : MoviePlayerStudy

이번에는 IOS에서 동영상을 재생하는 방법을 알아보았습니다.

이러한 동영상을 재생하는 방법은 앱 내에 있는 동영상을 재생하는 방법과 링크상에 있는 동영상을 재생하는 방법2 가지로 되어있습니다.

이번 프로젝트는 실습이 쉽다보니 실습을 같이 했습니다. 다양한 포맷의 영상파일을 재생하는 방법이였는데 왜이니지는 몰라도 m4v형식의 동영상은 잘 재생이 되지 않았습니다.

영상을 재생하는 방법 자체는 간단해서 다행입니다.

![스크린샷 2020-08-06 오전 7 10 09](https://user-images.githubusercontent.com/16849874/89641826-834e0a80-d8ed-11ea-9312-663ff0a212da.png)

---

## 포토라이브러리나 카메라에서 이미지 가져오기

이번에는 앨범이나 카메라에서 영상이나 이미지를 가져오는 프로젝트를 진행했습니다.

IOS는 델리게이트를 이용해서 뷰나 모듈끼리 소통을 하는 부분이 신기하고 집중해야 하는 부분인것 같습니다.

이미지를 가져와서 보여주는 프로젝트입니다.

![스크린샷 2020-08-08 오후 5 29 00](https://user-images.githubusercontent.com/16849874/89706860-76d8b900-d9a4-11ea-8605-5f34d4ee2e2f.png)

---

## 포토라이브러리나 카메라에서 이미지 가져오기 실습

위에서 진행한 프로젝트를 가지고 콜라주를 만드는 작업을 했습니다.

자동 레이아웃을 아직 잘 이해하지 못했는지 자꾸 레이아웃이 엇나가는 상황이 나타났었습니다.

프로젝트 자체의 백엔드적인 부분은 해결입니다.

사진을 가져올 때마다 하나씩 이미지 뷰에 할당을 하는 역할을 합니다.

![스크린샷 2020-08-08 오후 6 19 17](https://user-images.githubusercontent.com/16849874/89706892-bb645480-d9a4-11ea-8808-8b012d86c1bc.png)
